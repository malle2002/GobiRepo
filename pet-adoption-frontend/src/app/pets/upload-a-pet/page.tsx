...
export default function UploadAPet() {
  const { register, handleSubmit, onSubmit, errors, handleImageChange, previewImages, loading } = useUploadPet();
  ...
  return (
    <div className="container mx-auto w-3/4 md:w-2/3 p-6 bg-transparent shadow-lg rounded-lg my-12">
      ...
      <form onSubmit={handleSubmit(onSubmit)} method="POST" className="space-y-6">
        {step === 1 && (
          <div className="space-y-6">
            ...
            <button type="button" onClick={handleSubmit(nextStep)} className="btn btn-primary w-full mt-4">Next</button>
          </div>
        )}
