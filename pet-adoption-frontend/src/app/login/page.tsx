...
export default function Login() {
    const { formData, handleChange, handleSubmit, loading, errors } = useAuthForm({ type: "login" });
        ...
        <div className="flex items-center justify-center min-h-screen px-4 py-10">
            <div className="relative card w-full max-w-md shadow-xl bg-base-100 p-8">
                ...
                <form className="space-y-6 mt-6" onSubmit={handleSubmit}>
                    ...
                    <DisabledButtonOnClick disabled={loading} text="Login" textOnDisabled="Logging in..." />
                </form>
